...
class ComputedStyle {
  ...
  int get hashCode => Object.hashAll([
    display, writingMode, direction, inlineSize, blockSize, minInlineSize,
    minBlockSize, maxInlineSize, maxBlockSize, boxSizing, marginBlockStart,
    marginBlockEnd, marginInlineStart, marginInlineEnd, paddingBlockStart,
    paddingBlockEnd, paddingInlineStart, paddingInlineEnd, borderBlockStartWidth,
    borderBlockEndWidth, borderInlineStartWidth, borderInlineEndWidth,
    borderBlockStartStyle, borderBlockEndStyle, borderInlineStartStyle,
    borderInlineEndStyle, borderBlockStartColor, borderBlockEndColor,
    borderInlineStartColor, borderInlineEndColor, backgroundColor, fontFamily,
    fontSize, fontWeight, fontStyle, underline, lineThrough, lineHeight,
    color, whiteSpace, verticalAlign, textAlign, textIndent, textWrap,
    hyphens, language, hyphenateLimitChars, overflowWrap, letterSpacing,
    wordSpacing, textTransform, fontFeatureSettings, tabStops, defaultTabStop,
    float, clear, breakBefore, breakAfter, breakInside, widows, orphans,
    listStyleType, listStylePosition, markerText, position, insetBlockStart,
    insetBlockEnd, insetInlineStart, insetInlineEnd, zIndex, transform,
