...
const centerTransformOrigin =
    TransformOrigin(x: Length.percent(50), y: Length.percent(50));
...
final initialComputedStyle = ComputedStyle(
  ...
  marginBlockStart: const ComputedLengthValue(
      ComputedPxLength(0)), // wait, it's 0 in TS, meaning px
